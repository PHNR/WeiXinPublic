...
<head>
  ...
  <title>功能导航_狗扑微信平台GopeCMS_微信营销推广行业领导品牌</title>
  <meta name="keywords"  content="狗扑微信平台TM、微官网、微客服、微会员、微商圈、微电商、微营销、微支付、微推广"/>
  <meta name="description"  content="全面的狗扑微信平台TM功能导航：微官网、微会员、微客服、微推广、微团购、微投票、微统计、微门店、微活动、微报名、微行业、微定制"/>
	...
	<div class="wrap">
		...
		<div class="header-nav">
			<ul>
				...
				<li>
					<a href="<?php echo U('Home/Index/news');?>" class="active">媒体报道</a>
				</li>
				<li>
  ...
  <div class="clearfix article">
    <div class="article-top">
      <div class="wrap">
        <div class="edit-box">
          <h4>媒体报道</h4>
          <small>当前页面内容请在：\tpl\Home\pigcms\Index_news.html 中修改</small>
          <p class="text-center">
