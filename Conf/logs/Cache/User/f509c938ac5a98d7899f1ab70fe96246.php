...
<tr>
<th>相册头部图片外链地址:</th>
<td><input type="text" name="picurl" id="picurl" value="<?php echo ($headpic); ?>" class="px" style="width:400px;"><script src="/tpl/static/upyun.js"></script>
...
&nbsp; <button type="submit" name="homesubmit" value="true" class="btnGreen vm"><strong>修改</strong></button></td>
</tr></tbody></table>
                            </form>
</div>
<div class="cLine">
...
&nbsp; <a href="<?php echo U('Photo/edit',array('token'=>session('token'),'id'=>$photo['id']));?>">编辑</a>
&nbsp; <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Photo/del',array('token'=>session('token'),'id'=>$photo['id']));?>');">删除</a>
</div>
</div>
