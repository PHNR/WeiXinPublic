...
<script src="tpl/system/common/js/jquery.min.js" type="text/javascript"></script>
</head>
...
<div class="box">
    ...
    <p>系统版本：<?php if($updateRecord.version): echo (date("Y-m-d",$updateRecord["version"])); else: ?>暂无版本记录<?php endif; ?>&nbsp;&nbsp;<a href="?g=System&m=System&a=checkUpdate" class="blue">检查更新</a> <?php if($canEnUpdate != 1): ?><span style="color:red;font-weight:bold">您的环境不支持本次更新，请升级成php5.4以上版本</span><?php endif; ?></p>
