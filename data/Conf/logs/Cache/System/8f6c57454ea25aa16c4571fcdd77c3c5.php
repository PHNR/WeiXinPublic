...
<table width="100%" height="100%" border=0 cellpadding="0" cellSpacing=0>
                ...
                <div class="tm">
                    <ul>
                        <?php if(is_array($nav)): $i = 0;
                            ...
                            else: foreach($__LIST__ as $key => $nav_val): $mod = ($i % 2);
                                ++$i; ?>
                                <li class="nav" id="link<?php echo($nav_val['id']); ?>">
                                <a href="#" onClick="JumpleftFrame('<?php echo U('System/menu', array(
                                        'pid' => $nav_val['id'], 'level' => 2,
                                        'title' => rawurlencode($nav_val['title'])
                                    )); ?>',<?php echo($nav_val['id']); ?>);"><?php echo($nav_val['title']); ?></a>
    ...
    <tr>
        <td height="100%" bgcolor="#ffffff">
            <table width="100%" height="100%" cellpadding="0" cellSpacing=0 border=0 borderColor="#ff0000">
                <tbody>
                <tr>
                    <td noWrap id="frmTitle" bgcolor="#ff0000" width="213">
                        <IFRAME frameBorder="0" id="left" name="left" scrolling="auto"
                                src="<?php echo U('System/menu'); ?>"
                    ...
                    <td width="100%">
                        <table height="100%" cellSpacing=0 cellPadding=0 width="100%" align="right" border=0>
                            ...
                            <tr>
                                <td align=right>
                                    <IFRAME id="main" name="main" style="width: 100%; HEIGHT: 100%"
                                            src="<?php echo U('System/main'); ?>" frameBorder=0></IFRAME>
                                </td>
                            </tr>
                            </tbody>
                        </table>
    ...
    <tr>
        <td>
            <div id="footer"><i class="tico"></i>

                <p class="fr"> Copyright &copy; 2013-2014 狗扑·微信平台版权所有 </p>
            </div>
        </td>
    </tr>
</table>
