...
<div class="set_top">
    <?php if(is_array($nav)): $i = 0;
        $__LIST__ = $nav;
        if(count($__LIST__) == 0) : echo "";
        else: foreach($__LIST__ as $key => $vo): $mod = ($i % 2);
            ++$i; ?>
            <li <?php if(ACTION_NAME == $vo['name']): ?>id="set_top_li_bg"<?php endif; ?>><a
                href="<?php echo U($action . '/' . $vo['name'], array(
                        'pid' => 6, 'level' => 3
                    )); ?>"><?php echo($vo['title']); ?></a></li><?php endforeach; endif;
    else: echo "";endif; ?>
</div>
    ...
    <td>
        ...
        <div>
            ...
            <input name="tp" type="text" class="text textMiddle inputQ" id="pic" size="80" readonly="readonly" />
						...
						<span class="ke-button-common" id="upload" style="margin-top: 8px;margin-left: 5px;"><input
                                type="button" class="ke-button-common ke-button" value="Upload">

						</span>

            说明:将对应的图片上传到服务器，复制地址黏贴到指定位置
    </td>
...
<tr>
    ...
    <td><input type="text" name="site_name" value="<?php echo C('site_name'); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：狗扑·微信平台</span>
...
<tr>
    ...
    <td><input type="text" class="ipt" id="banner1" name="banner1" value="<?php echo C('banner1'); ?>" size="45" />
        ...
        <input type="text" class="ipt" id="banner22" name="banner2" value="<?php echo C('banner2'); ?>" size="45" />
</tr>
...
<tr>
    ...
    <td><input type="text" class="ipt" id="banner3" name="banner3" value="<?php echo C('banner3'); ?>" size="45" />
        ...
        <input type="text" class="ipt" id="banner4" name="banner4" value="<?php echo C('banner4'); ?>" size="45" />
</tr>
...
<tr>
    ...
    <td><input type="radio" name="ischeckuser" value="true" <?php if(C('ischeckuser') === 'true') echo checked; ?> />注册时无需要审核<input
            type="radio" name="ischeckuser" value="false" <?php if(C('ischeckuser') === 'false') echo checked; ?> />注册时需要审核
    </td>
...
<tr>
    ...
    <td><textarea type="text" name="counts" class="ipt"
                  style="width:252px;height:25px;margin:5px 0 5px 0;" /><?php echo C('counts'); ?></textarea><span>&nbsp;&nbsp;例:18015578821</span>
...
<tr>
    ...
    <td><input type="text" name="baidu_map_api" value="<?php echo C('baidu_map_api'); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;<a
                href="http://lbsyun.baidu.com/apiconsole/key?application=key" target="_blank">点击获取</a></span>
...
<tr>
    ...
    <td><textarea type="text" name="about" class="ipt"
                  style="width:450px;height:450px;margin:5px 0 5px 0;" /><?php echo C('about'); ?></textarea><span>&nbsp;&nbsp;公司介绍</span>
...
<tr>
    ...
    <td><textarea type="text" name="keyword" class="ipt"
                  style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('keyword'); ?></textarea><span>&nbsp;&nbsp;一般不超过100个字符</span>
...
<tr>
    ...
    <td><textarea type="text" name="content" class="ipt"
                  style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('content'); ?></textarea><span>&nbsp;&nbsp;一般不超过200个字符</span>
...
<tr>
    ...
    <td><textarea type="text" name="copyright" class="ipt"
                  style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('copyright'); ?></textarea><span>&nbsp;&nbsp;例:weiwin版权所有</span>
