    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
        <form id="myform" action="<?php echo U('Site/insert'); ?>" method="post">
            ...
            <tr>
                ...
                <td><input type="radio" name="TOKEN_ON"
                           value="true" <?php if(C('TOKEN_ON') === 'true') echo checked; ?> />开启
                    <input type="radio" name="TOKEN_ON"
                           value="false" <?php if(C('TOKEN_ON') === 'false') echo checked; ?> />关闭
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="TOKEN_TYPE" value="<?php echo C('TOKEN_TYPE'); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:md5</span>
                </td>
            </tr>
            <tr>
                <td height="48" align="right"><strong>令牌错误重置：</strong></td>
                <td><input type="radio" name="TOKEN_RESET"
                           value="true" <?php if(C('TOKEN_RESET') === 'true') echo checked; ?> />开启
                    <input type="radio" name="TOKEN_RESET"
                           value="false" <?php if(C('TOKEN_RESET') === 'false') echo checked; ?> />关闭
                </td>
            </tr>
            <tr>
                <td height="48" align="right"><strong>字段验证：</strong></td>
                <td><input type="radio" name="DB_FIELDTYPE_CHECK"
                           value="true" <?php if(C('DB_FIELDTYPE_CHECK') === 'true') echo checked; ?> />开启
                    <input type="radio" name="DB_FIELDTYPE_CHECK"
                           value="false" <?php if(C('DB_FIELDTYPE_CHECK') === 'false') echo checked; ?> />关闭
                </td>
            </tr>
            <tr>
                <td height="48" align="right"><strong>参数过滤：</strong></td>
                <td><input type="text" name="VAR_FILTERS" value="<?php echo C('VAR_FILTERS'); ?>" class="ipt"
                           size="45" /><span>&nbsp;&nbsp;例如:trim</span>
            </tr>
