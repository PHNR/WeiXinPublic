...
<div class="content">
    ...
    <div class="msgWrap form">
        <form method="post"
              action="<?php if($taobao['keyword'] != ''): ?>index.php?g=User&m=Taobao&a=edit&token=<?php echo($_GET['token']); endif; ?>"
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="userinfoArea">
                ...
                <tr>
                    ...
                    <td><input type="text" name="keyword" id="title" value="<?php echo($taobao["keyword"]); ?>"
                               class="px" tabindex="1" size="80"><br />例如：衣服|靴子|袜子|内衣 <span
                            class="red">（触发类型为包含匹配）</span></td>
                </tr>
                <tr>
                    <th><span class="red">*</span><label for="tag">店铺名称:</label></th>
                    <td><input type="text" name="title" id="title" value="<?php echo($taobao["title"]); ?>" class="px"
                               tabindex="1" size="80"></td>
                </tr>
                <tr>
                    <th><span class="red">*</span><label for="pic">店铺封面图片：</label></th>
                    <td><input type="text" name="picurl" id="pic" value="<?php echo($taobao["picurl"]); ?>" class="px"
                               tabindex="1" size="80" readonly="readonly"><span class="ke-button-common" id="upload"
                                                                                style="margin-top: 3px;margin-left: 5px;"><input
                                type="button" class="ke-button-common ke-button" value="Upload"></span></td>
                </tr>
                <tr>
                    <th><span class="red">*</span><label for="tel">店铺地址：</label></th>
                    <td><input type="text" name="homeurl" id="homeurl" value="<?php echo($taobao["homeurl"]); ?>"
                               class="px" tabindex="1" size="80"> 请填写天猫或淘宝的店铺地址
                    </td>
                </tr>
                <tr>
                    <th valign="top"></th>
                    <td>例如：天猫3G店铺地址通常为：<a href="http://beilimy.m.tmall.com/"
                                          target="_blank">http://beilimy.m.tmall.com/</a>　 淘宝的3G店铺地址为：<a
                            href="http://shop104008058.m.taobao.com/"
                            target="_blank">http://shop104008058.m.taobao.com/</a><br />
                    </td>
                </tr>
                <tr>
                    <th></th>
                    <td>
                        <button type="submit" name="appidsubmit" value="true" class="btnGreen vm"><strong>保存</strong>
                        </button>
                    </td>
                </tr>
                </tbody>
