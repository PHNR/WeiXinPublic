...
<div class="cLineB">
    ...
    <h4>微网站url：<?php echo C('site_url');
        echo U('Wap/Index/index', array('token' => $_GET['token'])); ?></h4>
    ...
    <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">
        ...
        <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                <td><input type="text" name="title" value="<?php echo($home["title"]); ?>" class="px"
            ...
            <tr>
                ...
                <td><textarea style="width:560px;height:75px" name="info" id="info"
                              class="px"><?php echo($home["info"]); ?></textarea><br />最多填写120个字
                </td>
            ...
            <tr>
                ...
                <td><input type="text" name="picurl" id="picurl" value="<?php echo($home["picurl"]); ?>" class="px"
                           style="width:550px;">
            ...
            <tr>
                ...
                <td><input type="text" name="homeurl" id="homeurl" value="<?php echo($home["homeurl"]); ?>" class="px"
                           style="width:550px;">
                    <script src="/tpl/static/upyun.js"></script>
                    <a href="###" onclick="chooseFile('homeurl','background')" class="a_upload">选择</a> <a href="###"
                                                                                                          onclick="upyunPicUpload('homeurl',1500,1000,'<?php echo($token); ?>')"
                                                                                                          class="a_upload">上传</a>
                    <a href="###" onclick="viewImg('homeurl')">预览</a><br /> 只适用于引用第三方3G网站的链接
                </td>
            ...
            <tr>
                ...
                <td><textarea style="width:560px;height:75px" name="copyright" id="copyright"
                              class="px"><?php echo($home["copyright"]); ?></textarea><br />最多填写120个字
                </td>
            ...
            <td><input type="text" name="musicurl" id="musicurl" value="<?php echo($home["musicurl"]); ?>" class="px"
                       style="width:550px;"><a href="###" onclick="chooseFile('musicurl','music')"
                                               class="a_upload">选择</a><br /> 如果填写网站会出现播放器，如果不填写则不出现
            </td>
            ...
            <tr>
                ...
                <td><input type="text" name="dianhua" value="<?php echo($home["dianhua"]); ?>" class="px"
                           style="width:300px;"><br />主页展示上显示电话号码建议填写
                </td>
