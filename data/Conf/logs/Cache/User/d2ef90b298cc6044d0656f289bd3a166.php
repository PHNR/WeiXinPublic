...
<div class="content">
    ...
    <div class="msgWrap form">
        ...
        <div class="bdrcontent">
            <div id="div_ptype">
                <table class="ListProduct" border="0" style="margin-bottom:20px; border:2px #333 solid" cellSpacing="0"
                    ...
                    <tr>
                        <?php if($actinfo != null): ?>
                            ...
                            <td class="norightborder">
                                <?php if($actinfo['isopen'] == 0): ?><ahref="<?php echo U('Shake/change', array(
                                        'id' => $actinfo['id'], 'actid' => 0, 'token' => $_SESSION['token']
                                    )); ?>">启动</a>
                                <?php else: ?> <a href="<?php echo U('Shake/change', array(
                                        'id' => $actinfo['id'], 'actid' => 1, 'token' => $_SESSION['token']
                                    )); ?>">停止</a>
                                <a target="_blank"
                                   href="<?php echo U('Shake/show', array('token' => $_SESSION['token'])); ?>">
                                        前台</a><?php endif; ?>
                                <a href="<?php echo U('Shake/edit', array(
                                        'id' => $actinfo['id'], 'token' => $_SESSION['token']
                                    )); ?>">编辑</a>
                                <a href="<?php echo U('Shake/change', array(
                                        'id' => $actinfo['id'], 'actid' => 2, 'token' => $_SESSION['token']
                                    )); ?>" title="统计活动人数并关闭活动，无法再次开启">关闭</a>
                            </td>
                        <?php else: ?>
                ...
                <table class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
                    ...
                    <?php if(is_array($info)): $i = 0;
                        ...
                        if(count($__LIST__) == 0) : echo "";
                            ...
                            <td class="norightborder">
                                <a target="ddd" href="<?php echo U('Shake/check', array(
                                        'id' => $vo['id'], 'token' => $_SESSION['token']
                                    )); ?>">查看成绩</a>
