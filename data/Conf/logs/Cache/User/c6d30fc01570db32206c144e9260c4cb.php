...
<div class="content">
    ...
    <div class="cLineB">
        ...
        <a href="<?php echo U('Product/cats', array(
                'token' => $token, 'parentid' => $parentid, 'dining' => $isDining
        ...
        <div class="msgWrap bgfc">
            ...
            <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                <tr>
                    ...
                    <td><input type="text" name="name" value="<?php echo($set["name"]); ?>" class="px"
                ...
                <tr>
                    ...
                    <td><input type="text" name="logourl" id="pic" value="<?php echo($set["logourl"]); ?>"
                               class="px require" style="width:400px;" readonly="readonly" />
                        <script src="/tpl/static/upyun.js"></script>
                        <a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo($token); ?>')" class="a_upload">上传</a>
                        <a href="###" onclick="viewImg('pic')">预览</a></td>
                ...
                <tr>
                    ...
                    <td><textarea name="des" class="px"
                                  style="width:400px;height:80px;"><?php echo($set["des"]); ?></textarea></td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if($isDining != 1): ?><input type="hidden" value="0" name="dining" /><?php else: ?><input
                            type="hidden" value="1" name="dining" /><?php endif; ?>

                        <input type="hidden" value="<?php echo $parentid; ?>" name="parentid" />

                        <button type="submit" name="button" class="btnGreen">保存</button>
                        &nbsp; <a href="<?php echo U('Product/cats', array('token' => $token)); ?>" class="btnGray vm">取消</a>
                    </td>
