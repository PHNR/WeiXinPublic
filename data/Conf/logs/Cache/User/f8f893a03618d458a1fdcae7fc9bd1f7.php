            ...
            <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                <tr>
                    ...
                    <td><textarea style="width:560px;height:75px" name="info" id="info"
                                  class="px"><?php echo($other["info"]); ?></textarea><br />最多填写120个字
                    </td>
                </tr>
                <tr>
                    <th>回复图文关键词：</th>
                    <td><input type="text" name="keyword" value="<?php echo($other["keyword"]); ?>" class="px"
                               style="width:550px;"><br /> 注：只能填写一个关键词，此项如果填写，文字回复将会失效
                    </td>
                </tr>
                <th>&nbsp;</th>
                <td>
