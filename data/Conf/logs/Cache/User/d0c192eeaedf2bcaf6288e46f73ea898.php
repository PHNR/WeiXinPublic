...
<table class="ListProduct" border="0" style="margin-bottom:20px; border:2px #333 solid" cellSpacing="0" cellPadding="0"
       width="100%">
    ...
    <tr>
        ...
        <?php if($actinfo != null): ?>
            <td><?php echo($actinfo["acttitle"]); ?></td>
            ...
            <td><?php if($actinfo['background'] == null): ?>未设置自定义背景<?php else: ?><img style="width:100px"
                                                                                       src="<?php echo($info["background"]); ?>"><?php endif; ?>
            </td>
            ...
            <td class="norightborder">
                ...
                <?php if($actinfo['isact'] == 0): ?><ahref="<?php echo U('Wewall/change', array(
                        'id' => $actinfo['id'], 'actid' => 0, 'token' => $_SESSION['token']
                    )); ?>">启动</a>



                <?php else: ?> <a href="<?php echo U('Wewall/change', array(
                        'id' => $actinfo['id'], 'actid' => 1, 'token' => $_SESSION['token']
                    )); ?>">停止</a><?php endif; ?>



                <a target="_blank"
                   href="<?php echo U('Wewall/show', array('token' => $_SESSION['token'], 'id' => $actinfo['id'])); ?>">前台</a>



                <?php if($actinfo['ifcheck'] == 1): ?><a target="_blank"href="<?php echo U('Wewall/gocheck', array(
                        'token' => $_SESSION['token'], 'id' => $actinfo['id']
                    )); ?>">审核</a><?php endif; ?>
                ...
                <a href="<?php echo U('Wewall/change', array(
                        'id' => $actinfo['id'], 'actid' => 2, 'token' => $_SESSION['token']
                    )); ?>" title="统计活动结果并关闭游戏，无法再次开启">关闭</a>
    ...
    <?php if(is_array($info)): $i = 0;
        ...
        if(count($__LIST__) == 0) : echo "";
            ...
            <td class="norightborder">
                ...
                <a target="ddd"
                   href="<?php echo U('Wewall/result', array('id' => $vo['id'], 'token' => $_SESSION['token'])); ?>">查看结果</a>
