            ...
            <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                <tr>
                    ...
                    <td><select name="paytype" onchange="ccolumns(this.value)">
                            <option value="weixin" <?php if ($config["paytype"] == 'weixin'): ?>selected<?php endif; ?>>
                                微信支付
                            </option>
                            <option value="alipay" <?php if ($config["paytype"] == 'alipay'): ?>selected<?php endif; ?>>
                                支付宝
                            </option>
                            <option value="tenpay" <?php if ($config["paytype"] == 'tenpay'): ?>selected<?php endif; ?>>
                                财付通(WAP手机接口)
                            </option>
                            <option value="tenpayComputer"
                                    <?php if ($config["paytype"] == 'tenpayComputer'): ?>selected<?php endif; ?>>
                                财付通(即时到帐接口)
                            </option>
                        </select></td>
                </tr>
                ...
                <tr class="alipay" <?php if ($config["paytype"] != 'alipay'): ?>style="display:none"<?php endif; ?>>
                    <th width="120">PID：</th>
                    <td><input type="text" name="pid" value="<?php echo($config["pid"]); ?>" class="px"
                               style="width:550px;"></td>
                </tr>
                <tr class="alipay" <?php if ($config["paytype"] != 'alipay'): ?>style="display:none"<?php endif; ?>>
                    <th>KEY：</th>
                    <td><input type="text" name="key" value="<?php echo($config["key"]); ?>" class="px"
                               style="width:550px;"></td>
                </tr>

                <tr class="tenpay" <?php if ($config["paytype"] == 'alipay'): ?>style="display:none"<?php endif; ?>>
                    <th>appId：</th>
                    <td><input type="text" name="appid" value="<?php echo($config["appid"]); ?>" class="px"
                               style="width:350px;"> 公众号身份的唯一标识（使用财付通接口不用填写）
                    </td>
                </tr>
                <tr class="tenpay" <?php if ($config["paytype"] == 'alipay'): ?>style="display:none"<?php endif; ?>>
                    <th>paySignKey：</th>
                    <td><input type="text" name="paysignkey" value="<?php echo($config["paysignkey"]); ?>" class="px"
                               style="width:350px;"> 公众号支付请求中用于加密的密钥Key（使用财付通接口不用填写）
                    </td>
                </tr>
                <tr class="tenpay" <?php if ($config["paytype"] == 'alipay'): ?>style="display:none"<?php endif; ?>>
                    <th>AppSecret：</th>
                    <td><input type="text" name="appsecret" value="<?php echo($config["appsecret"]); ?>" class="px"
                               style="width:350px;"> （使用财付通接口不用填写）
                    </td>
                </tr>
                <tr class="tenpay" <?php if ($config["paytype"] == 'alipay'): ?>style="display:none"<?php endif; ?>>
                    <th>partnerId：</th>
                    <td><input type="text" name="partnerid" value="<?php echo($config["partnerid"]); ?>" class="px"
                               style="width:350px;"> 财付通商户身份的标识
                    </td>
                </tr>
                <tr class="tenpay" <?php if ($config["paytype"] == 'alipay'): ?>style="display:none"<?php endif; ?>>
                    <th>partnerKey：</th>
                    <td><input type="text" name="partnerkey" value="<?php echo($config["partnerkey"]); ?>" class="px"
                               style="width:350px;"> 财付通商户权限密钥Key
                    </td>
                </tr>
                </if>
                <th>&nbsp;</th>
