...
<?php if($es_data['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($es_data['id']); ?>" /><?php endif; ?>
	...
	<div class="control-group">
		...
		<div class="controls">
      <img class="thumb_img" id="cover_src" src="<?php echo (($es_data['cover'])?($es_data['cover']):'http://home.weiwin.cc/sucai/estate/1.jpg'); ?>" style="max-height:100px;">
      	<input type="text" name="cover" value="<?php echo (($es_data['cover'])?($es_data['cover']):'http://home.weiwin.cc/sucai/estate/1.jpg'); ?>" id="cover" class="px" style="width:150px;"  readonly="readonly"/><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('cover',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
