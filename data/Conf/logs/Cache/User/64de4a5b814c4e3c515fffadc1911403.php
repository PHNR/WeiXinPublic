...
<div class="msgWrap">
  ...
  <form class="form" method="post"   action="<?php echo U('Wewall/upsave');?>"  target="_top" enctype="multipart/form-data" >
...
<TR>
  ...
  <TD><input type="input" class="px" id="acttitle"  name="acttitle" style="width:500px"  value="<?php echo ($info["acttitle"]); ?>" >    </TD>
...
<TR>
  ...
  <TD><label for="radio1"><input id="radio1" class="radio" type="radio" name="ifcheck" value="1" <?php if(($info["ifcheck"]) == "1"): ?>checked="checked"<?php endif; ?> > 需要</label>&nbsp;&nbsp;&nbsp;<label for="radio2"><input class="radio" id="radio2" type="radio" name="ifcheck" value="0" <?php if(($info["ifcheck"]) == "0"): ?>checked="checked"<?php endif; ?> /> 不需要</label></TD>
...
<TR>
  ...
  <TD><!--<label for="radio1"><input id="radio1" class="radio" type="radio" name="iflottery" value="1"  <?php if(($info["iflottery"]) == "1"): ?>checked="checked"<?php endif; ?> /> 需要</label>&nbsp;&nbsp;&nbsp;--><label for="radio2"><input class="radio" id="radio2" type="radio" name="iflottery" value="0" <?php if(($info["iflottery"]) == "0"): ?>checked="checked"<?php endif; ?> /> 不需要</label></TD>
...
<TR>
  ...
  <TD><input type="input" class="px" id="showtime"  name="showtime" style="width:50px" value="<?php echo ($info["showtime"]); ?>" >  数字越大服务器负担越小，但是要考虑客户体验!



<input type="hidden" name="isact" value="<?php echo ($info["isact"]); ?>">>
...
<input type="hidden" name="createtime" value="<?php echo ($info["createtime"]); ?>" />
...
<TR>
  ...
  <TD><input type="input" class="px" id="bonu1"  name="bonu1" style="width:50px" value="<?php echo ($info["bonu1"]); ?>" >  不开启抽奖功能的话无需填写
...
<TR>
  ...
  <TD><input type="input" class="px" id="bonu2"  name="bonu2" style="width:50px" value="<?php echo ($info["bonu2"]); ?>" >  不开启抽奖功能的话无需填写
...
<TR>
  ...
  <TD><input type="input" class="px" id="bonu3"  name="bonu3" style="width:50px" value="<?php echo ($info["bonu3"]); ?>" >  不开启抽奖功能的话无需填写
...
<TR>
  ...
  <TD><input type="input" class="px require"  id="pic" name="background" style="width:250px" value="<?php echo ($info["background"]); ?>" > <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a></td>定义前台页面背景，为URL地址
