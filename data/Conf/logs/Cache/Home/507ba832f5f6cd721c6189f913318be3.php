...
<head>
    ...
    <link rel="stylesheet" href="<?PHP echo RES ?>/css/1001.css" type="text/css" charset="utf-8">
</head>
<body id="w-body" class="w-login-bg">
<iframe style="display: none; "></iframe>
<style
    type="text/css">.WPA3-SELECT-PANEL { z-index: 2147483647; width: 463px; height: 292px; margin: 0; padding: 0; border: 1px solid #d4d4d4; background-color: #fff; border-radius: 5px; box-shadow: 0 0 15px #d4d4d4;
    ?
    >
...
<style
    ...
    ?
    >
    .WPA3-CONFIRM-CLOSE { position: absolute; top: 7px; right: 7px; width: 10px; height: 10px; cursor: pointer; ? ></style>
<div class="w-doc">
        ...
        <div class="w-wrap">
            ...
            <div class="w-left w-margin10">
                ...
                <div class="w-head-login">
                    <a href="<?PHP echo U('Index/login') ?>" class="">登录</a>&nbsp;｜&nbsp;<a
                        href="<?PHP echo U('Index/reg') ?>" class="">注册</a></div>
            </div>
            <ul class="w-menu Menu">
                ...
                <?php if($_SESSION[uid] == false): ?>
                    <li><a href="<?PHP echo U('Index/login') ?>">登录后台</a></li>
                    <li><a href="<?PHP echo U('Index/reg') ?>" class="hover">申请试用</a></li>
                <?php else: ?>
                    <li><a href="<?PHP echo U('User/Index/index') ?>">管理中心</a></li>
                    <li><a href="/#"
                           onClick="Javascript:window.open('<?PHP echo U('System/Admin/logout') ?>','_blank')">退出</a>
                    </li><?php endif; ?>
            </ul>
        </div>
    </div>
...
<!--产品与服务-->
<div style="left: 50.5px; top: 153px; display: none; position: fixed !important;" class="ProSer2 MenuChildren"
     id="ProSer2">
...
<div class="w-banner">
    <div class="w-wrap">
        <div class="w-banner-left">
            <a class="w-banner-block1 jfade_image" title="招商加盟政策，亲，了解了就来加盟吧" href="#"
               style="opacity: 0.36523704267472457; ">
                <div class="w-join"></div>
                <h6>零门槛加盟</h6>
            </a>
            <a class="w-banner-block2 jfade_image AddAttribute" href="javascript:" title="亲，在这里填写微云端代理商申请表哦！"
               style="opacity: 0.36523704267472457; ">
        ...
        <div class="w-banner-right">
            <a class="w-banner-block4 jfade_image" title="看！全国首发四网合一超级商城详解介绍，太niu了" href="#"
               style="opacity: 0.36523704267472457; ">
                <div class="w-mall"></div>
            </a>
            <a class="w-banner-block5 jfade_image" title="哇哦，智能wifi微信加粉广告宣传的利器" href="#"
               style="opacity: 0.36523704267472457; ">
                <div class="w-wifi"></div>
            </a>
            <a class="w-banner-block6 jfade_image" title="免费咨询热线<?PHP echo C('phone') ?>，欢迎来电哦"
               style="opacity: 0.36523704267472457; ">
                <div class="w-tel w-left"></div>
                <div class="w-banner-text2"><?PHP echo C('phone') ?></div>

            </a>
            <a class="w-banner-block7 jfade_image"
               href="http://wpa.qq.com/msgrd?v=3&uin=<?PHP echo C('site_qq') ?>&site=qq&menu=yes" target="_blank">
                    ...
                    <div class="infiniteCarousel">
                        <div class="wrapper" style="overflow: hidden; ">
                            <ul style="width: 9999px; ">
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;"
                                    class="cloned"><img
                                        style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                        src="<?PHP echo RES ?>/images/vcase13.jpg"
                                        onmouseover="this.src=&#39;http://static.wydapp.com/images/case13-cord.jpg&#39;;"
                                        onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase13.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;"
                                    class="cloned"><img
                                        style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                        src="<?PHP echo RES ?>/images/vcase14.jpg"
                                        onmouseover="this.src=&#39;http://static.wydapp.com/images/case14-cord.jpg&#39;;"
                                        onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase14.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;"
                                    class="cloned"><img
                                        style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                        src="<?PHP echo RES ?>/images/vcase15.jpg"
                                        onmouseover="this.src=&#39;http://static.wydapp.com/images/case15-cord.jpg&#39;;"
                                        onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase15.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;"
                                    class="cloned"><img
                                        style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                        src="<?PHP echo RES ?>/images/vcase16.jpg"
                                        onmouseover="this.src=&#39;http://static.wydapp.com/images/case16-cord.jpg&#39;;"
                                        onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase16.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase1.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case1-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase1.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase2.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case2-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase2.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase3.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case3-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase3.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase4.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case4-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase4.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase5.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case5-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase5.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase6.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case6-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase6.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase7.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case7-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase7.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase8.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case8-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase8.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase9.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case9-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase9.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase10.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case10-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase10.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase11.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case11-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase11.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase12.jpg"
                                         onmouseover="this.src=&#39;http://static.wydapp.com/images/case12-cord.jpg&#39;;"
                                         onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase12.jpg&#39;">
                                </li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;">
                                    <img style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                         src="<?PHP echo RES ?>/images/vcase13.jpg"
                                ...
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;"
                                    class="cloned"><img
                                        ...
                                        src="<?PHP echo RES ?>/images/vcase1.jpg"
                                        onmouseover="this.src=&#39;http://static.wydapp.com/images/case1-cord.jpg&#39;;"
                                        onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase1.jpg&#39;"></li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;"
                                    class="cloned"><img
                                        style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                        src="<?PHP echo RES ?>/vcase2.jpg"
                                        onmouseover="this.src=&#39;http://static.wydapp.com/images/case2-cord.jpg&#39;;"
                                        onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase2.jpg&#39;"></li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;"
                                    class="cloned"><img
                                        style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                        src="<?PHP echo RES ?>/images/vcase3.jpg"
                                        onmouseover="this.src=&#39;http://static.wydapp.com/images/case3-cord.jpg&#39;;"
                                        onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase3.jpg&#39;"></li>
                                <li style="background:url(http://static.wydapp.com/images/case-shadow.jpg) center bottom no-repeat;"
                                    class="cloned"><img
                                        style="border:1px solid #dcdcdc;border-bottom:none;padding:1px;margin:0;"
                                        src="<?PHP echo RES ?>/images/vcase4.jpg"
                                        onmouseover="this.src=&#39;http://static.wydapp.com/images/case4-cord.jpg&#39;;"
                                        onmouseout="this.src=&#39;http://static.wydapp.com/images/vcase4.jpg&#39;"></li>
                            </ul>

                        </div>
                        <a class="w-prev" style="top: 55%;"></a><a class="w-next" style="top: 55%;"></a>
    ...
    <div class="w-wrap">
        <div class="w-left" style="position:relative; height:520px; width:580px;">
            <div style=" position:absolute; top:50%; margin-top:-150px">
                ...
                <div style="w-wall-btn-wrap"><a href="#" class="w-mall-btn" title="查看详情">查看详情</a> <a href="#"
                                                                                                     class="w-mall-btn"
                                                                                                     title="查看演示"
...
<div id="WOSBtn_wx"
     style="position: absolute; display: block; right: 1px; top: 125px; width: 126px; height: 500px; z-index: 1000; ">
    <div id="BtnQQ" class="online-left online-hidden"></div>
    <div class="online-right">
        <a class="online_M online-tc" href="http://wpa.qq.com/msgrd?v=3&uin=<?PHP echo C('site_qq') ?>&site=qq&menu=yes"
           target="_blank"></a>
        ...
        <ul class="online-phone">
            <li>
                <a href="#">
                    ...
                    <div class="phone-nub"><?PHP echo C('phone') ?></div>
                </a>
            </li>
            <li>
                <a href="#">
...
<div class="footer">
    <div class="footer-content clearfix">
        ...
        <div class="copyright">
            Copyright © 2013-2014 <?PHP echo C('site_url') ?>. All Rights Reserved <?PHP echo C('site_name') ?>
            版权所有 <?PHP echo C('ipc') ?>
        </div>
    </div>
</div>
