...
DoSetDbChar('utf8');
E_D("DROP TABLE IF EXISTS `tp_meirong`;");
E_C("CREATE TABLE `tp_meirong` (
...
E_D("replace into `tp_meirong` values('52','avljgc1397041839','美容','美容1','0','http://wzweixiang.com/tpl/static/sucai/meirong/1.jpg','0','0','0','http://wzweixiang.com/tpl/static/sucai/meirong/2.png','','http://wzweixiang.com/tpl/static/sucai/meirong/4.png','','','','倒萨大的撒','倒萨大','倒萨大','','Meirong');");
