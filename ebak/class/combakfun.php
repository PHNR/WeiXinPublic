...
\$phpsafemod=\"" . addslashes(empty($add['sphpsafemod'])? '' : $add['sphpsafemod']) . "\";
\$php_outtime=\"" . addslashes(empty($add['sphp_outtime']) ? '' : $add['sphp_outtime']) . "\";
\$limittype=\"" . addslashes(empty($add['slimittype']) ? '' : $add['slimittype']) . "\";
\$canlistdb=\"" . addslashes(empty($add['scanlistdb']) ? '' : $add['scanlistdb']) . "\";
