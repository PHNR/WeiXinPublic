...
class TagLibCx extends TagLib {
    ...
    protected $tags = array(
        ...
        'default' => array('attr' => '', 'close' => 0), 'compare' => array(
        ...
        'empty' => array('attr' => 'name', 'level' => 3), 'notempty' => array('attr' => 'name', 'level' => 3),
        'present' => array('attr' => 'name', 'level' => 3), 'notpresent' => array('attr' => 'name', 'level' => 3),
        'defined' => array('attr' => 'name', 'level' => 3), 'notdefined' => array('attr' => 'name', 'level' => 3),
    ...
    public function _import($attr, $content, $isFile = false, $type = '') {
        ...
        if(isset($tag['value'])) {
            ...
            $name = array_shift($varArray);
            $name = $this->autoBuildVar($name);
            if(!empty($varArray)) $name = $this->tpl->parseVarFunction($name, $varArray); else
                $name = 'isset(' . $name . ')';
