...
class ZhuangxiuAction extends BaseAction
{
    ...
    public function _initialize()
    {
        ...
        $get_ids = M('Zhuangxiu')->where(array(
            'token' => $this->token,'addtype' => 'zhuangxiu'
    ...
    {
        $t_impress = M('Zhuangxiu_impress');
        $t_imp_add = M("Zhuangxiu_impress_add");
    ...
    public function aboutus()
    {
        ...
        $about   = $company->where(array(
            'token' => $token,'shortname'=>'zhuangxiu'
        ))->find();
