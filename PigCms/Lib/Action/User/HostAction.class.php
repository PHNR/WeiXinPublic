    ...
    public function admin(){
		...
		if(isset($_GET['download'])){
            ...
            if(!empty($li)){
                foreach($li as $rs){
                    $_rs = array(
                        'book_people' => $rs['book_people'],
                        'tel' => $rs['tel'],
						'check_in' => $rs['check_in']=date("Y-m-d H:i:s",  $rs['check_in']),
						'or_date' => $rs['or_date'],
						'room_type' => $rs['room_type'],
						 'book_time' => $rs['book_time']=date("Y-m-d",$rs['book_time']),
						  'book_num' => $rs['book_num'],
						   'price' => $rs['price'],
						   'date' => $rs['date'],
            ...
            $keynames = array('book_people'=>'姓名','tel'=>'电话','check_in'=>'入住时间','room_type'=>'房间类型','book_time'=>'预订时间','book_num'=>'预订数量','price'=>'价格','date'=>'下单时间');
